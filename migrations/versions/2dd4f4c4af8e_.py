...
Revision ID: 2dd4f4c4af8e
Revises: None
Create Date: 2015-12-25 02:51:58.046787

"""

# revision identifiers, used by Alembic.
revision = '2dd4f4c4af8e'
down_revision = None
...
def upgrade():
    ...
    sa.Column('verdict', sa.Enum('Accepted', 'Wrong Answer', 'Runtime Error', 'Time Limit Exceeded', 'Memory Limit Exceeded', 'Restrict Function', 'Output Limit Exceeded', 'Presentation Error', 'Compile Error', name='oj_verdict_types'), nullable=True),
    sa.Column('log', sa.String(length=1024), nullable=True),
    sa.ForeignKeyConstraint(['problem_id'], ['problem.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
