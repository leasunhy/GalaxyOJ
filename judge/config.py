...
COMPILER_OPTION_LIST = [
        ["-o", "a.out", "-m32", "-O2", "-Wall", "-lm", "--static", "-DONLINE_JUDGE"],
        ["-o", "a.out", "-m32", "-O2", "-Wall", "-lm", "--static", "-std=c99", "-DONLINE_JUDGE"],
        ["-o", "a.out", "-m32", "-O1", "-Co", "-Cr", "-Ct", "-Ci"],
        ["-o", "a.out", "-m32", "-O2", "-Wall", "-lm", "-std=c++11", "--static", "-DONLINE_JUDGE"]]
